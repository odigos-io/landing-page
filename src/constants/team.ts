export const TEAM = [
  {
    ...
    description:
      'Ari brings over 20+ years of experience across tech, software, finance, and energy, combining strategic insight with hands-on leadership.\n\nAs Co-Founder & CEO of Odigos, he leads with a passion for innovation and a deep understanding of the global and Israeli tech ecosystems.',
    image: '/assets/team/ari_recht.jpg',
    linkedin: 'https://www.linkedin.com/in/arirecht',
  },
  {
    name: 'Eden Federman',
  ...
  },
  {
    ...
    title: 'HR Manager',
    description:
      'Ktora is the HR Manager at Odigos, bringing over 8 years of experience in Human Resources, with a strong background in building tech teams across EMEA and the US from early-stage startups to large enterprises.\n\nAt Odigos, Ktora leads all HR functions, including people experience, talent acquisition, and people operations, and is actively involved in nurturing the company culture as Odigos continues to grow globally.',
    image: '/assets/team/ktora_tsur.jpg',
