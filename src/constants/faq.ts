export const FAQ = [
  ...
  {
    title: 'Is capturing new data in live production safe?',
    description:
      'It runs out of process in eBPF, under 1% CPU. It never loads into your application, so a bad release of ours stops at our sensor. What may be captured, and by whom, is governed by RBAC and policy controls, and every capture is scoped to the workload you point it at.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Not on day one. Odigos runs alongside Datadog, New Relic, Honeycomb, Grafana Cloud, and the open source stack (Jaeger, Tempo, Loki, SigNoz). It captures what they never reach. Most teams start there. Many end up replacing them.',
  },
  {
    title: 'Which programming languages are supported?',
    description:
      'Go, Java, Python, .NET, JavaScript, PHP, and Ruby, with more landing constantly, including the compiled runtimes most tools skip.',
  },
  {
