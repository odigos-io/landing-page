...
const DESC = 'Our own eBPF runtime reads what happens inside a running process, in every language, with nothing loaded into your application. Function-level depth, Odigos Autofocus that captures deeper the moment a service drifts, exported as OpenTelemetry, under 1% CPU.';
