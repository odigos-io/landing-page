...
export const XrayArt = () => (
  <Art viewBox='0 0 200 138' aria-hidden>
    ...
    <TreeNode $y={66}>
      <text x={156} y={68} fill={HOT} fillOpacity={0.95} style={{ fontSize: 4.2, fontWeight: 500 }}>
        args
      </text>
      <text x={156} y={73.5} fill={HOT} fillOpacity={0.95} style={{ fontSize: 4.2, fontWeight: 500 }}>
        return
      </text>
    </TreeNode>
