...
image: '~/assets/images/trace_cicd.png'
...
![Tracing Adoption Chart](adoption.png)
...
![Kubernetes and Databases Trace](trace_kube.png)
...
![Frontend and Cloud Providers Trace](trace_frontend.png)
