...
![Simplest Log Pipeline](/simplest_log_pipeline.png)
...
![Logs Pipeline with Agent](/logs_pipeline_with_agent.png)
...
![Logs Pipeline with Gateway](/logs_pipeline_with_gateway.png)
...
![Logs Pipeline Agent with Gateway](/logs_pipeline_agent_with_gateway.png)
...
Such a tool is [Odigos](https://github.com/keyval-dev/odigos) which is an OpenSource tool that automatically instrument your cloud services and ship logs (and traces and metrics) to your backend of choice. It is a great way to implement OpenTelemetry instantly, without any code changes. It automatically deploys modern log pipeline with no manual effort.
