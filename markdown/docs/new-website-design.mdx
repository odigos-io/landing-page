...
---
We are happy to announce that we’ve launched a new [website for Odigos](https://odigos.io/), our [open-source platform](https://github.com/keyval-dev/odigos) that simplifies OpenTelemetry complexity and instantly generates distributed traces. The new website features a more modern design, improved navigation, and a focus on Odigos's observability capabilities.
