...
description: 'Collectors overview and why we chose the OpenTelemetry collector'
metadata: Odigos simplifies observability with automatic instrumentation, collector management, and easy scalability. It streamlines data collection, ensuring efficient end-to-end observability for modern applications.
category: 'Odigos'
tags: [collectors, odigos, opentelemetry]
---
...
![Collectors Figure 1](/assets/blogs/collectors-overview/collectors_figure1.png)
...
![Collectors Figure 2](/assets/blogs/collectors-overview/collectors_figure2.png)
