...
description: 'How Odigos do context propagation for Go applications'
metadata: Today, we're thrilled to unveil Go automatic instrumentation v0.6 and Odigos v0.1.3, enhancing observability for Go developers by enabling automatic context propagation in any Go application.
category: 'Odigos'
tags: [golang, odigos, distributed-traces, ebpf]
---
...
![Automatically created distributed trace](/assets/blogs/effortless-tracing-for-go/vote_trace.png)
...
- [GitHub Issues](https://github.com/odigos-io/odigos)
