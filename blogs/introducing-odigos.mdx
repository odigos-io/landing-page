...
description: 'An introduction to Odigos - an open source observability control plane'
metadata: Explore the capabilities of Odigos, an open-source observability control plane that simplifies observability for organizations of all sizes.
category: 'Odigos'
tags: [observability, odigos, opentelemetry, ebpf]
---

Introducing [Odigos](https://github.com/odigos-io/odigos)! an Open-Source Observability Control Plane that allows organizations to create & maintain their observability pipeline.
